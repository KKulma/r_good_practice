...
I've been asked more and more for hints and best practices when working with R. It may seem obvious or simple, but it can be a daunting task, depending how deep or specialised you want to be. Also, there's lots (and I mean, LOTS) good advice out there that you should definitely check out (see some examples in the Reference section below), but I hope this post will fill in some of the gaps.
...
knitr::include_graphics("pics/code_sections.png")
```
...
```{r, out.width = "550px", echo=FALSE}
knitr::include_graphics("pics/red_dot.png")
```
